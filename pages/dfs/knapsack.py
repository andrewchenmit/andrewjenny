...
def main():
    ...
    def solve_fantasy_knapsack(data, salary_cap, roster_spots, min_point, min_eff, max_tier, projection):
        ...
        if pulp.LpStatus[prob.status] == 'Optimal':
            ...
            best = pd.DataFrame(answer, columns=["Pos","Name","Salary","Points"])
