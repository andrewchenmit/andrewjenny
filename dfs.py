...
def knapsack():
    ...
    solution['lineups'].append(solve_fantasy_knapsack('RB/WR/TE Max 6 Vegas', data, salary_cap, roster_spots, 3, {'QB': 0.3, 'RB': 0.3, 'WR': 0.3, 'TE': 0.3, 'DEF': 0.3}, {'QB': 99, 'RB': 6, 'WR': 6, 'TE': 6, 'DEF': 99}, 'vegas'))
    solution['lineups'].append(solve_fantasy_knapsack('RB/WR/TE Max 5 Vegas', data, salary_cap, roster_spots, 3, {'QB': 0.3, 'RB': 0.3, 'WR': 0.3, 'TE': 0.3, 'DEF': 0.3}, {'QB': 99, 'RB': 5, 'WR': 5, 'TE': 5, 'DEF': 99}, 'vegas'))
    solution['lineups'].append(solve_fantasy_knapsack('Max 9 Vegas', data, salary_cap, roster_spots, 3, {'QB': 0.3, 'RB': 0.3, 'WR': 0.3, 'TE': 0.3, 'DEF': 0.3}, {'QB': 9, 'RB': 9, 'WR': 9, 'TE': 9, 'DEF': 9}, 'vegas'))
    solution['lineups'].append(solve_fantasy_knapsack('Max 8 Vegas', data, salary_cap, roster_spots, 3, {'QB': 0.3, 'RB': 0.3, 'WR': 0.3, 'TE': 0.3, 'DEF': 0.3}, {'QB': 8, 'RB': 8, 'WR': 8, 'TE': 8, 'DEF': 8}, 'vegas'))
    solution['lineups'].append(solve_fantasy_knapsack('Max 7 Vegas', data, salary_cap, roster_spots, 3, {'QB': 0.3, 'RB': 0.3, 'WR': 0.3, 'TE': 0.3, 'DEF': 0.3}, {'QB': 7, 'RB': 7, 'WR': 7, 'TE': 7, 'DEF': 7}, 'vegas'))
    solution['lineups'].append(solve_fantasy_knapsack('Max 6 Vegas', data, salary_cap, roster_spots, 3, {'QB': 0.3, 'RB': 0.3, 'WR': 0.3, 'TE': 0.3, 'DEF': 0.3}, {'QB': 6, 'RB': 6, 'WR': 6, 'TE': 6, 'DEF': 6}, 'vegas'))
    solution['lineups'].append(solve_fantasy_knapsack('Max 5 Vegas', data, salary_cap, roster_spots, 3, {'QB': 0.3, 'RB': 0.3, 'WR': 0.3, 'TE': 0.3, 'DEF': 0.3}, {'QB': 5, 'RB': 5, 'WR': 5, 'TE': 5, 'DEF': 5}, 'vegas'))
    ...
    solution['lineups'].append(solve_fantasy_knapsack('RB/WR/TE Max 6 FP', data, salary_cap, roster_spots, 3, {'QB': 0.3, 'RB': 0.3, 'WR': 0.3, 'TE': 0.3, 'DEF': 0.3}, {'QB': 99, 'RB': 6, 'WR': 6, 'TE': 6, 'DEF': 99}, 'fp'))
    solution['lineups'].append(solve_fantasy_knapsack('RB/WR/TE Max 5 FP', data, salary_cap, roster_spots, 3, {'QB': 0.3, 'RB': 0.3, 'WR': 0.3, 'TE': 0.3, 'DEF': 0.3}, {'QB': 99, 'RB': 5, 'WR': 5, 'TE': 5, 'DEF': 99}, 'fp'))
    ...
    solution['lineups'].append(solve_fantasy_knapsack('Max 6 FP', data, salary_cap, roster_spots, 3, {'QB': 0.3, 'RB': 0.3, 'WR': 0.3, 'TE': 0.3, 'DEF': 0.3}, {'QB': 6, 'RB': 6, 'WR': 6, 'TE': 6, 'DEF': 6}, 'fp'))
    solution['lineups'].append(solve_fantasy_knapsack('Max 5 FP', data, salary_cap, roster_spots, 3, {'QB': 0.3, 'RB': 0.3, 'WR': 0.3, 'TE': 0.3, 'DEF': 0.3}, {'QB': 5, 'RB': 5, 'WR': 5, 'TE': 5, 'DEF': 5}, 'fp'))
    print("LENGTH")
    print(len([lineup for lineup in solution['lineups'] if lineup is not None]))
    if len([lineup for lineup in solution['lineups'] if lineup is not None]) == 0:
        ...
        solution['lineups'].append(solve_fantasy_knapsack('RB/WR/TE Max 6 Tier', data, salary_cap, roster_spots, 3, {'QB': 0.3, 'RB': 0.3, 'WR': 0.3, 'TE': 0.3, 'DEF': 0.3}, {'QB': 99, 'RB': 6, 'WR': 6, 'TE': 6, 'DEF': 99}, 'tier'))
        ...
        solution['lineups'].append(solve_fantasy_knapsack('Max 6 Tier', data, salary_cap, roster_spots, 3, {'QB': 0.3, 'RB': 0.3, 'WR': 0.3, 'TE': 0.3, 'DEF': 0.3}, {'QB': 6, 'RB': 6, 'WR': 6, 'TE': 6, 'DEF': 6}, 'tier'))
    solution['lineups'] = [lineup for lineup in solution['lineups'] if lineup is not None]
    return solution
